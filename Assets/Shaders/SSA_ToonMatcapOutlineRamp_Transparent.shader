Shader "SSA/ToonMatcapOutlineRamp_Transparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct v2f { float4 posCS:SV_POSITION; };
        ...
        Pass
        {
            ...
            struct v2f { float4 posCS:SV_POSITION; float3 posWS:TEXCOORD0; float3 nWS:TEXCOORD1; float2 uv:TEXCOORD2; };
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float ramp = SAMPLE_TEXTURE2D(_RampTex, sampler_RampTex, float2(NdotL, 0.5)).r;
